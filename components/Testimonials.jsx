...
const Testimonials = () => {
  return (
    <>
      <div className="testimonials-bg mb-5 p-5">
        <Container>
          <Row>
            <Col sm={12}>
              <div className="p-md-5 pt-4 mx-md-5">
                ...
                <p className="text-white mt-5 w-50 ms-auto mb-5">
        ...
        <Container>
          <Row>
            <Col xs={12} md={7} className="ms-md-auto">
              <div className="d-flex justify-content-between border p-2 gap-2 bg-white testimonials-con">
                ...
                <div className="w-50 d-flex flex-column p-4">
                  ...
                  />
                  <p className="fw-light">
                    I admire and salute Chartered for their commitment to
